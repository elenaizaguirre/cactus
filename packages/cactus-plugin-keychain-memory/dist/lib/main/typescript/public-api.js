...
Object.defineProperty(exports, "PluginKeychainMemory", { enumerable: true, get: function () { return plugin_keychain_memory_1.PluginKeychainMemory; } });
var plugin_factory_keychain_1 = require("./plugin-factory-keychain");
Object.defineProperty(exports, "PluginFactoryKeychain", { enumerable: true, get: function () { return plugin_factory_keychain_1.PluginFactoryKeychain; } });
const plugin_factory_keychain_2 = require("./plugin-factory-keychain");
async function createPluginFactory(pluginFactoryOptions) {
    return new plugin_factory_keychain_2.PluginFactoryKeychain(pluginFactoryOptions);
}
